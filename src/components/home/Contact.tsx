...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      try {
        const mailtoLink = `mailto:nitikabhatia205@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(
          ...
          <div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a 
                  href="https://github.com/nitikabhatiaa" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.linkedin.com/in/nitikabhatia30/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
